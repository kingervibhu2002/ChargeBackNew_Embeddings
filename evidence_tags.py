...
EVIDENCE_TAG_LABELS: dict = {
    ...
    "single_credit_confirmed":          "Confirmed only one credit was issued (independently verified — bank statement, ledger export, or CBS record cited)",
    "single_credit_self_reported":      "Merchant states only one credit was issued (unverified — no ledger/CBS record cited)",
